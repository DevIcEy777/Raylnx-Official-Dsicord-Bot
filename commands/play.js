...
module.exports = {
    ...
    run: async function (client, message, args) {
        ...
        const play = async (song) => {
            ...
            if (!song) {
                sendError(
                    "Leaving the voice channel because I think there are no songs in the queue. I f you want me to stay in the vc 24/7 there is no need to execute an external command. i will be in vc as long as yopu want if you want me to leave vc type z!disconnect.",
                    message.channel
                );
