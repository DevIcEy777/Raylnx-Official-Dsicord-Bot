...
module.exports = {
    ...
    run: async function (client, message, args) {
        ...
        const Embed = new MessageEmbed()
            ...
            .setColor("GREEN")
            .setTitle("Success")
            .setDescription("<a:madgif:792345081290031105>  Left The Voice Channel.")
            .setTimestamp();

        return message.channel.send(Embed).catch(() => message.channel.send("<a:madgif:792345081290031105> Left The Voice Channel :C"));
    },
};
